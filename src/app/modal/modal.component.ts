...
export class ModalComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal,private element: ElementRef,private formbuilder:FormBuilder,private http:HttpClient,private userService: UserService,private ipAdd:IpServiceService,public router:Router) {
    this.Createform();
   }
